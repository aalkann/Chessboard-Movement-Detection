...
def findCorners(frame):
    ...
    _, binaryinv = cv.threshold(gray, 27, 255, cv.THRESH_BINARY_INV)
...
video_capture = cv.VideoCapture("/home/eray/Desktop/Chessboard-Movement-Detection-main/source/chess.mp4")
